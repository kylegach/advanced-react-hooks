...
- Why function dependencies of useEffect need memoized in some way
- How useCallback helps with that
- Extract useReducer and useEffect logic into a custom hook
- Considering DX when making an API
- Cleaning up issues when components are unmounted
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=02%3A%20useCallback%3A%20custom%20hooks&em=kyle.gach%40gmail.com).
