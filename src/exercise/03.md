...
- createContext API
- How context works and why to use it or not
- Creating your own provider component and why to do so
- Custom context hook
- Safeguarding against referencing context values outside of their provider
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=03%3A%20useContext%3A%20simple%20Counter&em=kyle.gach%40gmail.com).
