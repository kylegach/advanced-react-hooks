...
- useDebugValue, didn't know about this one either!
- useful way to log debug values only when in dev mode
- When to use "formatValue" (second) argument
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=06%3A%20useDebugValue%3A%20useMedia&em=kyle.gach%40gmail.com).
